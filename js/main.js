...
const scriptURL = 'https://script.google.com/macros/s/AKfycbzmCmhrHHparu0BDA-_pOgn52xuH9xutTOo68pBhni_2pBKJ52lgNMHqqx1Ww5UzuD6Dw/exec';
const form = document.forms['Fadly-Contact-Us'];
...
form.addEventListener('submit', e => {
    ...
    fetch(scriptURL, { method: 'POST', body: new FormData(form) })
        .then(response => {
            // Mengembalikan teks tombol kembali menjadi "Send Message"
...
// Menyembunyikan pemberitahuan ketika tombol "Send Message" diklik kembali
